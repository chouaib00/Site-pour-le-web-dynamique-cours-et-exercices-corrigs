...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<h1>Travaux pratiques N°6, Web dynamique</h1>
		</div>
	</div>
    <!-- tp1 -->
 <div class="row" style='margin-left : 5px; margin-right : 5px '>
        <div class="col-sm-10 col-sm-offset-1">
          <div class="panel panel-primary" style="height :auto">
			...
			<p><b>On utilisant l'outi PhpMyAdmin, créer Ia base de donnée «« scott ».<br>
			Les tables seront générées automatiquement en important Ie schéma relationnel « scott.sql ».<br>
					Connectez-vous à cette base de données.</b></p>
				<h2>Exercice 1</h2>
					<p>Réaliser un formulaire contenant un nom d'utilisateur et un mot de passe. Vérifier que le
						compte utilisateur existe dans la table « passwd >>. Un mes§age (un div situé au haut du
						formulaire) est apparu affichant une authentification réussite où une connexion
						échouée.
						
						
					</p>
					<center><img src="images/ex1_tp6.PNG"></center>
                 <span><a  href="tp6/ex1/ex1_acceuil.php">Solution</a></span>
				<h2>Exercice 2</h2>
					<p>Ajouter au formulaire de l'exercice 1 un lien hypertexte qui permet d'ajouter un nouveau
						compte. Ce lien va vous diriger vers une page qui vous perrnettra de créer un nouvel ernployé
						dans la table « emp », et par conséquant, un nouveau compte dans la table « passwd ».<br>
						<b>1.</b> Créer un fichier comportant une fonction « list_option » qui permet de créer une liste.
						Cette fonction accepte comme arguments : un tableau des éléments de la liste et le
						nom de la liste.<br>
						<b>2.</b> Créer un fichier comportant une fonction « list_modifiable » qui permet de créer une
						liste modifiable en utilisant le « datalist » de HTML5. Cette fonction accepte comme
						arguments : un tableau des éléments de la liste et le nom de la liste.<br>
						<b>3.</b> Créer une interface/formulaire permettant de saisir les données du nouvel employé (le
						login et le mot de passe sont le nom de l'employé et son numéro).</p>
										<center><img src="images/ex2_tp6.PNG"></center>
                         <span><a  href="tp6/ex2/ex1_acceuil.php">Solution</a></span>
